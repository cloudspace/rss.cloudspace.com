  ...
  def process
    HTTParty.post(ENV['MICROSERVICE_API_URL'] + '/jobs',
                  body: {
                    ...
                    user_params: {
                      'url_1423779563727' => "#{feed_item.url}",
                      'prefix_1423779567279' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423779567279' => '',
                      'urlsecurity_1423779567279' => '',
                      'imageprefix_1423779566717' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423779566717' => '',
                      'urlsecurity_1423779566717' => '',
                      'imageprefix_1423779566509' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423779566509' => '',
                      'urlsecurity_1423779566509' => '',
                      'imageprefix_1423779566324' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423779566324' => '',
                      'urlsecurity_1423779566324' => '',
                      'feedid_1423779564410' => "#{feed_item.feed.id}",
                      'feeditemid_1423779564410' => "#{feed_item.id}",
                      'url_1423779564410' => "#{feed_item.url}",
                      'publishedat_1423779564410' => "#{feed_item.published_at}",
                      'title_1423779564410' => "#{feed_item.title}"
                    }
                  }.to_json,
