  ...
  def process
    HTTParty.post(ENV['MICROSERVICE_API_URL'] + '/jobs',
                  body: {
                    ...
                    user_params: {
                      'url_1423773345728' => "#{url}",
                      'prefix_1423773347177' => "feed_items/#{id}",
                      'filesecurity_1423773347177' => '',
                      'urlsecurity_1423773347177' => '',
                      'imageprefix_1423773360408' => "feed_items/#{id}",
                      'filesecurity_1423773360408' => '',
                      'urlsecurity_1423773360408' => '',
                      'imageprefix_1423773360564' => "feed_items/#{id}",
                      'filesecurity_1423773360564' => '',
                      'urlsecurity_1423773360564' => '',
                      'imageprefix_1423773360750' => "feed_items/#{id}",
                      'filesecurity_1423773360750' => '',
                      'urlsecurity_1423773360750' => '',
                      'feedid_1423773355692' => "#{feed.id}",
                      'feeditemid_1423773355692' => "#{id}",
                      'url_1423773355692' => "#{url}",
                      'publishedat_1423773355692' => "#{published_at}",
                      'title_1423773355692' => "#{title}"
                    }
                  }.to_json,
