  ...
  def process
    HTTParty.post(ENV['MICROSERVICE_API_URL'] + '/jobs',
                  body: {
                    ...
                    user_params: {
                      'url_1423689864729' => "#{url}",
                      'prefix_1423689874660' => "feed_items/#{id}",
                      'filesecurity_1423689874660' => '',
                      'urlsecurity_1423689874660' => '',
                      'imageprefix_1423689876392' => "feed_items/#{id}",
                      'filesecurity_1423689876392' => '',
                      'urlsecurity_1423689876392' => '',
                      'imageprefix_1423689876641' => "feed_items/#{id}",
                      'filesecurity_1423689876641' => '',
                      'urlsecurity_1423689876641' => '',
                      'imageprefix_1423689876854' => "feed_items/#{id}",
                      'filesecurity_1423689876854' => '',
                      'urlsecurity_1423689876854' => '',
                      'feedid_1423689866110' => "#{feed.id}",
                      'feeditemid_1423689866110' => "#{id}",
                      'url_1423689866110' => "#{url}",
                      'publishedat_1423689866110' => "#{published_at}",
                      'title_1423689866110' => "#{title}"
                    }
                  }.to_json,
