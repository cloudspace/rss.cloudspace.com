  ...
  def process
    HTTParty.post(ENV['MICROSERVICE_API_URL'] + '/jobs',
                  body: {
                    ...
                    user_params: {
                      'url_1423779563727' => "#{url}",
                      'prefix_1423779567279' => "feed_items/#{id}",
                      'filesecurity_1423779567279' => '',
                      'urlsecurity_1423779567279' => '',
                      'imageprefix_1423779566717' => "feed_items/#{id}",
                      'filesecurity_1423779566717' => '',
                      'urlsecurity_1423779566717' => '',
                      'imageprefix_1423779566509' => "feed_items/#{id}",
                      'filesecurity_1423779566509' => '',
                      'urlsecurity_1423779566509' => '',
                      'imageprefix_1423779566324' => "feed_items/#{id}",
                      'filesecurity_1423779566324' => '',
                      'urlsecurity_1423779566324' => '',
                      'feedid_1423779564410' => "#{feed.id}",
                      'feeditemid_1423779564410' => "#{id}",
                      'url_1423779564410' => "#{url}",
                      'publishedat_1423779564410' => "#{published_at}",
                      'title_1423779564410' => "#{title}"
                    }
                  }.to_json,
