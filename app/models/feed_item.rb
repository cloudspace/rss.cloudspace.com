    ...
    HTTParty.post(ENV['MICROSERVICE_API_URL'] + '/jobs',
                  body: {
                    ...
                    user_params: {
                      ...
                      'prefix_1424182098498' => "feed_items/#{id}",
                      'filesecurity_1424182098498' => '',
                      'urlsecurity_1424182098498' => '',
                      'imageprefix_1424182103045' => "feed_items/#{id}",
                      'filesecurity_1424182103045' => '',
                      'urlsecurity_1424182103045' => '',
                      'imageprefix_1424182103309' => "feed_items/#{id}",
                      'filesecurity_1424182103309' => '',
                      'urlsecurity_1424182103309' => '',
                      'imageprefix_1424182103511' => "feed_items/#{id}",
                      'filesecurity_1424182103511' => '',
                      'urlsecurity_1424182103511' => '',
                      'feedid_1424182091240' => "#{feed.id}",
                      'feeditemid_1424182091240' => "#{id}",
                      'url_1424182091240' => "#{url}",
                      'publishedat_1424182091240' => "#{published_at}",
                      'title_1424182091240' => "#{title}"
                    }
                  }.to_json,
