  ...
  def process
    HTTParty.post(ENV['MICROSERVICE_API_URL'] + '/jobs',
                  body: {
                    ...
                    user_params: {
                      'url_1423775068167' => "#{feed_item.url}",
                      'prefix_1423775070359' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423775070359' => '',
                      'urlsecurity_1423775070359' => '',
                      'imageprefix_1423775093984' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423775093984' => '',
                      'urlsecurity_1423775093984' => '',
                      'imageprefix_1423775094312' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423775094312' => '',
                      'urlsecurity_1423775094312' => '',
                      'imageprefix_1423775094153' => "feed_items/#{feed_item.id}",
                      'filesecurity_1423775094153' => '',
                      'urlsecurity_1423775094153' => '',
                      'feedid_1423775071000' => "#{feed_item.feed.id}",
                      'feeditemid_1423775071000' => "#{feed_item.id}",
                      'url_1423775071000' => "#{feed_item.url}",
                      'publishedat_1423775071000' => "#{feed_item.published_at}",
                      'title_1423775071000' => "#{feed_item.title}"
                    }
                  }.to_json,
